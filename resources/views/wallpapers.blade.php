...
<head>
    ...
    <title>Free Wallpapers - ZEDGE™</title>
...
<div class="w-screen h-14 pt-[3px] pb-0 overflow-x-scroll shadow-[#555] shadow-sm bg-white flex items-center justify-start sm:justify-center">
    ...
    <div class="cursor-pointer text-lg text-slate-700 h-full flex items-center justify-center border-b-4 border-b-purple-500 px-3 text-center mx-2"><a class="w-full h-full flex text-purple-500  items-center justify-center" href="/wallpapers">Wallpapers</a></div>
    ...
    <div class="cursor-pointer text-lg text-slate-700 h-full flex items-center justify-center  border-b-purple-500 px-3 text-center mx-2"><a class="w-full h-full flex items-center justify-center whitespace-nowrap" href="/live-wallpapers">Live Wallpapers</a></div>
</div>


<div class="wallpapers-holder mt-4 px-8 card-holder w-screen grid xl:grid-cols-7 md:grid-cols-5 sm:grid-cols-3 grid-cols-2 gap-3 overflow-y-scroll">
