...
<head>
    ...
    <title>Free Ringtones and Wallpapers - ZEDGE™</title>
...
<div class="w-screen h-14 pt-[3px] pb-0 overflow-x-scroll shadow-[#555] shadow-sm bg-white flex items-center justify-start sm:justify-center">
    ...
    <div class="cursor-pointer text-lg text-slate-700 h-full flex items-center justify-center  border-b-purple-500 px-3 text-center mx-2"><a class="w-full whitespace-nowrap h-full flex items-center justify-center" href="/live-wallpapers">Live Wallpapers</a></div>
