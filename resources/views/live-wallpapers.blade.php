    ...
    *::-webkit-scrollbar { 
    ...
    <div class="cursor-pointer text-lg text-slate-700 h-full flex items-center justify-center border-b-4  border-b-purple-500 px-3 text-center mx-2"><a class="w-full h-full text-purple-500  flex items-center justify-center" href="/live-wallpapers">Live Wallpapers</a></div>
</div>
